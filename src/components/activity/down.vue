		...
		<div class="table_record">
			  <el-table
			    ...
			    <el-table-column
			      ...
			      width="100">
			      <template slot-scope="scope">
			        <el-button v-show="scope.row.btn.detail" @click="searchDetail(scope.row,'detail')" type="text" size="small">查看</el-button>
				        <el-button v-show="scope.row.btn.delete" @click="searchdetele(scope.row,'search')" type="text" size="small">删除</el-button>
