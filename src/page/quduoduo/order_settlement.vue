 ...
 <div class="business_listings">
		...
		<div class="search_admin_list_table">
			...
			<div class="search_btn">
				...
				<div class="search_content">
					<span>结算状态</span>
					<div class="width-120">
					  <el-select v-model="form.is_prom_put_status" placeholder="全部">
					    <el-option
					      v-for="item in isPromPutStatus_option"
					      :key="item.value"
					      :label="item.label"
					      :value="item.value">
					    </el-option>
					...
					<picker style="float:left;margin-bottom:10px;" :title="titleLabelFour" @onPassByVal='getTime4'></picker>
  ...
  <el-dialog
    ...
    <div class="warp_dialog">
        <el-radio v-model="examineForm.type" label="1">已结算</el-radio>
        <el-radio v-model="examineForm.type" label="2">不结算</el-radio>
    </div>
    <div class="warp_dialog">
        <span class="width_guding">拒绝原因：</span>
        <span class="reason_text">
      <textarea v-model="examineForm.remarks" style="height: 50px;width: 370px;resize: none;"></textarea>
        </span>
    </div>
...
import make_fun from '../../js/make_fun.js';
 export default {
     ...
     return {
       ...
       examineForm:{
        ...
        status_option:[],
     	  ...
     	  titleLabelOne:'收货时间',
     	  titleLabelTwo:'审核时间',
     	  titleLabelThree:'创建时间',
     	  titleLabelFour:'订单结算时间',
     	  currentPage:1,
    		totals:0,
    		pageSize:10,
     	  tableData: [],
   ...
   created(){
       this.fetch();
		   make_fun.searchConfSettlement("order/searchConf",this);
   },
   components: {
        breadcrumb,picker
   },
   methods:{
     examineDataFun(){
          var data = {
              ...
              type:this.examineForm.type,
          }
      		make_fun.orderAuditSettle("order/orderAuditSettle",data,this);
     },
     editStatus(params){
       this.examineForm.order_sn = params.order_sn;
       this.examineForm.remarks = params.remarks;
       this.examineForm.type = params.is_prom_check_status;
     ...
     fetch(val){
          ...
          is_prom_put_status:this.form.is_prom_put_status,
          ...
          prom_put_time_map:this.form.prom_put_time_map=="NaN-0NaN-0NaN 0NaN:0NaN:0NaN/NaN-0NaN-0NaN 0NaN:0NaN:0NaN"?"":this.form.prom_put_time_map,
    		}
    		make_fun.promotionList("order/orderSettle",data,this);
     },
     	getTime1(msg){
     		if(msg!=undefined){
    	...
    	getTime4(msg){
    		if(msg!=undefined){
 	   		if(msg[0]!='NaN-0NaN-0NaN'){
 	   			     this.form.prom_put_time_map = msg[0] +'/'+ msg[1];
 	        }else{
 	   			     this.form.prom_put_time_map = '';
 	        }
         }else{
    			    this.form.prom_put_time_map = '';
         }
