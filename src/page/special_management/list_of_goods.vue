		...
		<div class="search_admin_list_table">
			...
			<div class="search_btn">
				<!--<div class="search_content">
					<div class="width-120">
					  <el-select v-model="form.exclusive" placeholder="专场">
					    <el-option
				...
				<div class="search_content">
					<el-button type="primary" @click="addEntryDetail()">添加商户商品</el-button>
				</div>
			</div>
...
import Classification from '../../js/special_field_classification.js';
 export default {
   ...
   created(){
		...
		Classification.GoodsspecialList("Goodsspecial/list",data,this);
   ...
   methods:{
   	editStoreCountFun(){
		...
		Goods.editField("goods/editField",data,this,"activeProductLine");
   	},
   	...
   	deleteRow(params){
          ...
          var data = {
			...
			Classification.GoodsspecialDel("Goodsspecial/del",data,this,params);
        }).catch(() => {
          this.$message({
            type: 'info',
            message: '已取消删除'
      ...
      addEntryDetail(){
          this.$router.push({name:'special_list_goods_detail'})
      },
		entryDetail(id){
