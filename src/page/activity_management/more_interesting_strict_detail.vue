										...
										<tr>
											...
											<td><div class="select_thirty">
											    <div class="width_120_warp">
											      <el-select @focus="getFocusList()" v-model="icon_id" placeholder="选择专场">
											        <el-option
...
breadcrumb
   ...
   methods:{
   	...
   	searchList(){
   		...
   		More.searchGoodsStrict("Strict/searchGoods",data,this);
   	},
   	getGoodsSearch(){
   	...
   	saveList(){   		
   		...
   		More.ActivityiconAdd("Strict/add",data,this);
