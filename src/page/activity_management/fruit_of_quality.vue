...
import Goods from '../../js/list_of_goods.js';
	...
	export default {
		data() {
			return {
				...
				content_title: {
					title1: "品质水果",
					title2: "",
					path1:'/home/activityManagement/fruitQuality',
					path2:''
				}
			}
		},
   	...
   	editStoreCountFun(){
		...
		Goods.editField("goods/editField",data,this,"activeProduct");
   	},
   	...
   	changeRecommend(params){
		...
		Goods.editField("goods/editField",data,this,"activeProduct");
			...
			editListData(id) {
				this.$router.push({name:'list_of_goods_detail',query:{id:id,title:"fruitQuality"}})
			},
			selectOption() {
				var data = {
					page: this.currentPage,
