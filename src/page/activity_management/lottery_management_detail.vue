...
breadcrumb
   ...
   methods:{
   	...
   	searchList(){
   		...
   		Lottery.searchGoods("Awardgoods/searchGoods",data,this);
   	},
   	...
   	saveList(){
   		...
   		Lottery.SecondbuyAdd("Awardgoods/add",data,this);
   	},
		entryDetail(id){
			this.$router.push({name:'customer_complaint_management_detail'})
		},      
