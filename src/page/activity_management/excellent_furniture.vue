   ...
   data () {
     return {
		...
		content_title:{
			title1: "家具优品",
			title2: "",
			path1:'/home/activityManagement/excellentFurniture',
			path2:''
		}
     }
   },
...
breadcrumb
   ...
   methods:{
   	...
   	changeRecommend(params){
		...
		editListData(id) {
			this.$router.push({name:'list_of_goods_detail',query:{id:id,title:"excellentFurniture"}})
		},
	   	selectOption(){
		   	var data = {
		   		page:this.currentPage,
		...
		entryDetail(id){
			this.$router.push({name:'fruit_of_quality_detail',query:{id:id,type:13}})
		},  
