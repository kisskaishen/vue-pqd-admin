			...
			<div class="search_admin_list_table">
				...
				<div class="table_list">
					<el-table :data="tableData" border style="width: 100%">
						...
						<!--<el-table-column prop="exclusive_name" label="专区名称">
						</el-table-column>-->
						<el-table-column prop="cate_name" label="分类">
						</el-table-column>
						<el-table-column prop="shop_price" label="市场价">
						</el-table-column>
						<el-table-column prop="prom_price" label="团购价">
						</el-table-column>
					...
					<div class="pagination">
						<el-pagination @current-change="handleCurrentChange" :current-page="currentPage" :page-size='pageSize' layout="total, prev, pager, next, jumper" :total='totals'>
						</el-pagination>
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		data() {
			return {
				...
				content_title: {
					title1: "省钱大法",
					title2: "",
					path1:'/home/activityManagement/lawSavingMoney',
					path2:''
				}
			}
		},
		created() {
			...
			Fruit.ActivgoodsList("Economize/list", data, this);
		},
		components: {
			breadcrumb
		},
   	...
   	editStoreCountFun(){
		...
		Fruit.editField("goods/editField",data,this,"saveMonry");
   	},
   	...
   	changeRecommend(params){
		...
		Fruit.editField("goods/editField",data,this,"saveMonry");
			...
			deleteListData(params) {
				this.$confirm('此操作将永久删除, 是否继续?', '提示', {
		          ...
		          type: 'warning'
					...
					Fruit.delActivgoods("Economize/del", data, this,params);
		        }).catch(() => {
		          this.$message({
		            type: 'info',
		            message: '已取消'
			...
			editListData(id) {
				this.$router.push({name:'list_of_goods_detail',query:{id:id,title:"lawSavingMoney"}})
