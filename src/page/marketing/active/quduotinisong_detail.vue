			...
			<div class="content_active">
				  <el-tabs v-model="activeName" @tab-click="handleClick">
				    ...
				    <el-tab-pane label="活动记录" name="3">
				    	...
				    	<div v-if="action=='give'">
							<give-record></give-record>
				    	</div>
				    </el-tab-pane>
				  </el-tabs>
			</div>
...
import give from '../../../components/activity/down';
import giveRecord from '../../../components/activity/give_record';
...
//   		]
   ...
   created(){
		...
		Market.activeInfo('Activities/userRecordDetails',data,this);
   ...
   methods:{
   	...
   	submitSetActive(){
        ...
        Market.handleUpdateActive('Activities/updateActiveInfo',data,this);
   	},
    onEditorBlur(){//失去焦点事件
    },
